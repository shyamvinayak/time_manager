...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void initState() {
    ...
    Provider.of<DatePickerModel>(context, listen: false).setSelectedDate(_now);
                ...
                child: FutureBuilder<List<CheckInOutRecord>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      return   Center(child: Lottie.asset(Assets.loading,width: 150,height: 150,fit: BoxFit.contain));
                      ...
                      return  Center(
                        child: Lottie.asset(Assets.no_dta_found,
                            fit: BoxFit.contain),
                      );
                    } else {
                      WidgetsBinding.instance.addPostFrameCallback((_) {
                      ...
                      return Consumer<DatePickerModel>(
                        builder: (context, value, child) {
                          List<CheckInOutRecord> selectedDateRecords =
                              groupedRecords[DateFormat('yyyy-MM-dd')
